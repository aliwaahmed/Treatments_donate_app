...
public class DonateProfileActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_donate_profile);
        ...
        mPatientDatabase = FirebaseDatabase.getInstance().getReference().child("do_Users").child(current_id);
        ...
        editBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final AlertDialog.Builder alert = new AlertDialog.Builder(DonateProfileActivity.this);
                ...
                mUserDatabase.addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        String info_name = dataSnapshot.child("do_name").getValue().toString();
                        String info_phone = dataSnapshot.child("do_phone").getValue().toString();
                        String info_add = dataSnapshot.child("do_address").getValue().toString();
                ...
                Dsave.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        mProgress = new ProgressDialog(DonateProfileActivity.this);
                        ...
                        mUserDatabase.child("do_man_name").setValue(Managername).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                        ...
                        mUserDatabase.child("do_name").setValue(DoctorName).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                        ...
                        mUserDatabase.child("do_phone").setValue(DoctorPhone).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
                        ...
                        mUserDatabase.child("do_address").setValue(DoctorAddress).addOnCompleteListener(new OnCompleteListener<Void>() {
                            @Override
                            public void onComplete(@NonNull Task<Void> task) {
        ...
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("do_Users");
        ...
        change_image.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                CropImage.activity()
                        ...
                        .start(DonateProfileActivity.this);
            }
        });

        mCurrentUser = FirebaseAuth.getInstance().getCurrentUser();
        String current_uid = mCurrentUser.getUid();
        mUserDatabase = FirebaseDatabase.getInstance().getReference().child("do_Users").child(current_uid);

        mUserDatabase.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {

                String name = dataSnapshot.child("do_name").getValue().toString();
                String phone = dataSnapshot.child("do_phone").getValue().toString();
                String Iaddress = dataSnapshot.child("do_address").getValue().toString();
                ...
                //
                if (!image.equals("")) {
                    Picasso.with(DonateProfileActivity.this).load(image).networkPolicy(NetworkPolicy.OFFLINE)
                        ...
                        public void onError() {
                            ...
                            Picasso.with(DonateProfileActivity.this).load(image).placeholder(R.drawable.avatar).into(mDisplayImage);
                        }
                    });
                }
            }
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if (requestCode == CropImage.CROP_IMAGE_ACTIVITY_REQUEST_CODE) {
            ...
            if (resultCode == RESULT_OK) {
                ...
                mProgressDilog = new ProgressDialog(DonateProfileActivity.this);
                                        ...
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                ...
                                                if (task.isSuccessful()) {
                                                    ...
                                                    Toast.makeText(DonateProfileActivity.this, "Profile image stored to firebase database successfully.", Toast.LENGTH_SHORT).show();
                                                } else {
                                                    String message = task.getException().getMessage();
                                                    Toast.makeText(DonateProfileActivity.this, "Error Occured..." + message, Toast.LENGTH_SHORT).show();
                                                }
                                            }
                                ...
                                mUserDatabase.child("thumb_image").setValue(downloadUrl)
                                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                                            ...
                                            public void onComplete(@NonNull Task<Void> task) {
                                                mProgressDilog.dismiss();
                                                if (task.isSuccessful()) {
                                                    Intent selfIntent = new Intent(DonateProfileActivity.this, Person_profile_activity.class);
